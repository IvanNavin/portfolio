...
const ru = {
  text: `English learning - это результат Реакт-марафона от Зара Захарова.</br>
...
const ua = {
  text: `English learning – це результат Реакт-марафону від Зара Захарова.</br>
...
const en = {
  text: `English learning is the result of the React Marathon from Zar Zakharov.</br>
        During this marathon we got acquainted with React and its life cycles, learned how to work with forms and with the Firebase server. From the marathon I got the skill how to work with props and states, and passed them through the components and back. To begin with, we wrote a self-written redux to understand how it works and later connected it. We took icons and shapes from the AntDesign collection. We connected the dictionary api and used the firebase storage to memorize user's words. Then we Attached React Router and Thunk.
        To use the site's capabilities, you need to enter an unknown English word in the input field. Further, this word will appear in the "Firebase" database and under the input field. If you click on a word, the card will flip and on the other side you can find the translation. This word can be crossed out as memorized or deleted as unnecessary and consequently removed from the base of your words.
        </br>
        Login: reactmarathon@gmail.com</br>
        Password: 12345678
        </br>`,
};
